...
, gawk
, withPerl ? stdenv.hostPlatform == stdenv.buildPlatform && lib.meta.availableOnPlatform stdenv.hostPlatform perl, perl
, withPython ? stdenv.hostPlatform == stdenv.buildPlatform && lib.meta.availableOnPlatform stdenv.hostPlatform python, python
, swig
, ncurses
, pam
, libnotify
